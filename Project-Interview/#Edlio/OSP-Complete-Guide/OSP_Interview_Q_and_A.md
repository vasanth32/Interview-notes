...
### [Question 1: What are the tasks you have done in your projects?](#question-1-what-are-the-tasks-you-have-done-in-your-projects-give-a-few-examples-not-all)
- [Answer Structure](#answer-structure)
- [Overview Response (30 seconds)](#overview-response-30-seconds)
- [Detailed Examples](#detailed-examples-pick-3-4-to-elaborate)
  - [Example 1: Identity & Access Service Implementation](#example-1-identity--access-service-implementation)
  - [Example 2: Notification Service with Multi-Channel Delivery](#example-2-notification-service-with-multi-channel-delivery)
  - [Example 3: Database Design - Database per Service Pattern](#example-3-database-design---database-per-service-pattern)
  - [Example 4: SQS Queue Implementation for Event-Driven Communication](#example-4-sqs-queue-implementation-for-event-driven-communication)
  - [Complete Implementation Guide: Order-Placed-Events with SQS](#complete-implementation-guide-order-placed-events-with-sqs)
    - [Part 1: Cloud-Side Setup (AWS Infrastructure-Guides)](#part-1-cloud-side-setup-aws-infrastructure)
    - [Part 2: API-Side Implementation - Order Service (Producer)](#part-2-api-side-implementation---order-service-producer)
    - [Part 3: API-Side Implementation - Notification Service (Consumer)](#part-3-api-side-implementation---notification-service-consumer)
    - [Part 4: Error Handling and Resilience](#part-4-error-handling-and-resilience)
...
- [Key Points to Emphasize](#key-points-to-emphasize)
- [Common Follow-up Questions](#common-follow-up-questions)
- [Tips for Answering](#tips-for-answering)

### [Question 2: Explain JWT Token, Refresh Token, Authentication, and Authorization - Full Flow](#question-2-explain-jwt-token-refresh-token-authentication-and-authorization---full-flow)
- [Overview](#overview)
- [Part 1: Full Flow Explanation](#part-1-full-flow-explanation)
  - [Authentication & Authorization Flow Diagram](#authentication--authorization-flow-diagram)
  - [Step-by-Step Flow Explanation](#step-by-step-flow-explanation)
    - [Phase 1: Initial Authentication (Login)](#phase-1-initial-authentication-login)
    - [Phase 2: Authenticated API Requests](#phase-2-authenticated-api-requests)
    - [Phase 3: Token Refresh Flow](#phase-3-token-refresh-flow)
  - [JWT Token Structure](#jwt-token-structure)
  - [Key Concepts](#key-concepts)
- [Part 2: Implementation Steps](#part-2-implementation-steps)
  - [Step 1: Project Setup](#step-1-project-setup)
  - [Step 2: Database Models](#step-2-database-models)
  - [Step 3: JWT Configuration](#step-3-jwt-configuration-appsettingsjson)
  - [Step 4: JWT Service Interface and Implementation](#step-4-jwt-service-interface-and-implementation)
  - [Step 5: Authentication Service](#step-5-authentication-service)
  - [Step 6: DTOs (Data Transfer Objects)](#step-6-dtos-data-transfer-objects)
  - [Step 7: Authentication Controller](#step-7-authentication-controller)
  - [Step 8: Configure JWT Authentication](#step-8-configure-jwt-authentication-programcs--startupcs)
  - [Step 9: Authorization Middleware](#step-9-authorization-middleware-optional---custom-authorization)
  - [Step 10: API Gateway Token Validation](#step-10-api-gateway-token-validation)
- [Part 3: Follow-Up Questions & Answers](#part-3-follow-up-questions--answers)
  - [Q1: Why use JWT instead of session-based authentication?](#q1-why-use-jwt-instead-of-session-based-authentication)
  - [Q2: How do you handle token revocation with JWT?](#q2-how-do-you-handle-token-revocation-with-jwt)
  - [Q3: How do you prevent token theft and XSS attacks?](#q3-how-do-you-prevent-token-theft-and-xss-attacks)
  - [Q4: How do you handle multi-tenancy in JWT tokens?](#q4-how-do-you-handle-multi-tenancy-in-jwt-tokens)
  - [Q5: What happens if refresh token is compromised?](#q5-what-happens-if-refresh-token-is-compromised)
  - [Q6: How do you handle token expiration on the client side?](#q6-how-do-you-handle-token-expiration-on-the-client-side)
  - [Q7: How do you implement rate limiting for login attempts?](#q7-how-do-you-implement-rate-limiting-for-login-attempts)
  - [Q8: How do you test JWT authentication?](#q8-how-do-you-test-jwt-authentication)
  - [Q9: How do you handle password reset flow?](#q9-how-do-you-handle-password-reset-flow)
  - [Q10: How do you implement role-based and permission-based authorization?](#q10-how-do-you-implement-role-based-and-permission-based-authorization)
- [Summary](#summary)
- [Additional: ASP.NET Core Identity Benefits](#additional-aspnet-core-identity-benefits)

### [Question 3: How did you deploy your .NET and Angular applications to AWS?](#question-3-how-did-you-deploy-your-net-and-angular-applications-to-aws)
- [Overview](#overview-1)
- [Deployment Architecture Overview](#deployment-architecture-overview)
- [Part 1: Angular Applications Deployment (Student Portal & Edlio Admin Portal)](#part-1-angular-applications-deployment-student-portal--edlio-admin-portal)
  - [Architecture: S3 + CloudFront](#architecture-s3--cloudfront)
  - [Step-by-Step Deployment](#step-by-step-deployment)
- [Part 2: .NET Core MVC Application Deployment (School Admin Portal)](#part-2-net-core-mvc-application-deployment-school-admin-portal)
  - [Architecture: EC2 with Application Load Balancer](#architecture-ec2-with-application-load-balancer)
  - [Step-by-Step Deployment](#step-by-step-deployment-1)
- [Part 3: .NET Core Web APIs Deployment (Microservices)](#part-3-net-core-web-apis-deployment-microservices)
  - [Architecture: ECS Fargate with Application Load Balancer](#architecture-ecs-fargate-with-application-load-balancer)
  - [Step-by-Step Deployment](#step-by-step-deployment-2)
- [Part 4: Database and Supporting Services](#part-4-database-and-supporting-services)
  - [RDS SQL Server Configuration](#rds-sql-server-configuration)
  - [ElastiCache Redis Configuration](#elasticache-redis-configuration)
  - [SQS Queue Configuration](#sqs-queue-configuration)
- [Part 5: CI/CD Pipeline](#part-5-cicd-pipeline)
- [Part 6: Monitoring and Logging](#part-6-monitoring-and-logging)
  - [CloudWatch Configuration](#cloudwatch-configuration)
  - [Application Insights](#application-insights)
- [Summary: Deployment Architecture](#summary-deployment-architecture)
...
6. **Migration Strategy**
   ...
   - Created migration Deployment-Scripts for each service
...
### **Part 1: Cloud-Side Setup (AWS Infrastructure-Guides)**
...
# - Infrastructure-Guides: AWS Fargate (Serverless)
```

...
- **Document Storage**: Stores uploaded documents (tranDeployment-Scripts, certificates, ID documents)
...
- **Infrastructure-Guides Monitoring**: Monitors ECS service metrics (CPU, memory, request count, error rate)

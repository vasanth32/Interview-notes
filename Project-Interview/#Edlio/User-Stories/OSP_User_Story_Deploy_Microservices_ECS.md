...
- **Infrastructure-Guides**: ECS Fargate, ECR, ALB, VPC, Security Groups
...
### Phase 2: AWS Infrastructure-Guides Setup (40 minutes)
...
3. Infrastructure-Guides: AWS Fargate (Serverless)
4. Create cluster

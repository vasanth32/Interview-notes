...
# Policies:
# - Restricted: No Deployment-Scripts
# - RemoteSigned: Local Deployment-Scripts OK, downloaded must be signed
# - Unrestricted: All Deployment-Scripts OK (not recommended)
```
...
10. **How do you schedule PowerShell Deployment-Scripts to run automatically?**

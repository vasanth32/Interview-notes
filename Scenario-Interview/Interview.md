...
- **Outer layers** (Infrastructure-Guides, API) depend on inner layers, not the other way around
...
- Outer (Infrastructure-Guides/API) = Walls/Roof - can be replaced (change database, UI, cloud)
...
- ✅ Infrastructure-Guides is pluggable
...
- Infrastructure-Guides depends on Application and Domain
...
- **Database Change**: Only Infrastructure-Guides layer changes
- **UI Change**: Only API layer changes
- **Cloud Migration**: Swap Infrastructure-Guides implementation

...
| **Layer** | Application | Infrastructure-Guides |
...
| **Layer** | Infrastructure-Guides | Application |
...
**Service Mesh:**
- **Type**: Infrastructure-Guides layer
- **Purpose**: Service-to-service communication
...
|--------|--------------|----------------|
| **Type** | Infrastructure-Guides | Platform |
...
**Best Practices:**
- Service mesh: Infrastructure-Guides layer

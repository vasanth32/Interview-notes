...
- **AWS Infrastructure-Guides**: EKS, ECR, RDS, SQS, CloudWatch, Secrets Manager, and more
...
### Containerization & Infrastructure-Guides

- **[POC-3: Service-Scoped Docker Images](#poc-3-service-scoped-docker-images)** - Dockerfiles and ECR setup
- **[POC-4: Terraform for Microservices Infra](#poc-4-terraform-for-microservices-infra)** - Infrastructure-Guides as code (EKS, RDS, SQS, CloudWatch)
...
### **What You Build:**
- Terraform Deployment-Scripts for shared infrastructure
- EKS cluster

...
- ✅ Azure Function Apps for batch processing
...
## 🗓️ Day 1: Core API & Database Layer (6-8 hours)
...
dotnet new classlib -n TaskManagement.Infrastructure-Guides -f net8.0
...
dotnet sln add TaskManagement.Infrastructure-Guides/TaskManagement.Infrastructure-Guides.csproj

# Add references
dotnet add TaskManagement.API reference TaskManagement.Core
dotnet add TaskManagement.Infrastructure-Guides reference TaskManagement.Core
dotnet add TaskManagement.API reference TaskManagement.Infrastructure-Guides
```

#### 1.2 Database Setup (Entity Framework Core)
```powershell
# Install EF Core packages
cd TaskManagement.Infrastructure-Guides
...
**Create DbContext** (`TaskManagement.Infrastructure-Guides/Data/`):
...
dotnet ef migrations add InitialCreate --project TaskManagement.Infrastructure-Guides --startup-project TaskManagement.API

# Update database
dotnet ef database update --project TaskManagement.Infrastructure-Guides --startup-project TaskManagement.API
```
...
**Implement Repositories** (`TaskManagement.Infrastructure-Guides/Repositories/`):
- `TaskRepository.cs`
- `UnitOfWork.cs`
...
## 🗓️ Day 2: Azure Functions & Integration (6-8 hours)
...
dotnet add reference ../TaskManagement.Infrastructure-Guides/TaskManagement.Infrastructure-Guides.csproj
```
...
dotnet add TaskManagement.Tests reference TaskManagement.Infrastructure-Guides
...
- ✅ Azure Functions execute on schedule
- ✅ Database operations work correctly
- ✅ Unit tests pass
- ✅ Code follows SOLID principles
- ✅ You can explain your architecture decisions
- ✅ You can demonstrate the BFF pattern
- ✅ You understand the migration path from .NET Framework to .NET Core
